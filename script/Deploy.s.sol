...
contract CollatzNumberDeploy is Script {
    function run() external {
        ...
        CollatzNumber collatzNumber = new CollatzNumber(verifier);
        console2.log("Deployed CollatzNumber to", address(collatzNumber));
